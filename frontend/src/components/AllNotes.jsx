...
function AllNotes() {
    ...
    const fetchNotes = async () => {
        try {
            const response = await axios.get('https://notetakingwebapp.onrender.com/notes/get-all-notes', {withCredentials: true})
    ...
    const handleDelete = async (noteId) => {
        try {
            // First move to recently deleted
            await axios.patch(
                `https://notetakingwebapp.onrender.com/notes/recently-deleted-notes/${noteId}`,
                {},
